  ...
  <section class="small-gap-start step-section container">
    <div class="step-panel mx-auto article-panel">
      <article class="cosmic-article mx-auto">
        ...
        <p class="step-copy article-copy">Make peace with past woundings…</p>
        <p class="step-copy article-copy">And become aware on the deepest level what qualities you need in your special Soulmate.</p>
        ...
        <p class="step-copy article-copy">After all, relationships are a key part of our health and happiness, and it’s hard to even put a price on the value of that connection.</p>
        <p class="step-copy article-copy">Most clients say they would have paid ten times that amount because of how loved, supported, and connected they feel now.</p>

        <p class="step-copy article-copy">They also learn things about themselves that apply to them and only them, that helped them attract others and keep super-connected, loving relationships as they move forward in their lives.</p>

        <p class="step-copy article-copy">As you have come this far and placed your trust in me today, I could not ask you for $600.</p>
        <p class="step-copy article-copy">Or even half of that.</p>
        <p class="step-copy article-copy">Or half of that again.</p>
        ...
        <p class="step-copy article-copy">That’s a fraction of their true value.</p>
        <p class="step-copy article-copy">I want to give you this massive discount because I can see what an amazing soul you are, and that you deserve this as much as anyone to have real love and connection with a soulmate in your life.</p>
        <p class="step-copy article-copy"><strong>Just click the button below</strong> to claim the reading and bonuses today.</p>
