@extends('layouts.app')
@section('title', 'Unlocked Your Cosmic Fortune Calendar Reports')
@section('content')
...
<div class="download-page vip">
    ...
    <div class="container">
        <div class="text-center mb-5">
            ...
            <h1 class="download-title">You’ve unlocked your <br><strong class="accent">Cosmic Fortune Calendar</strong> <strong> Report!</strong></h1>
            <p class="download-desc text-primary mb-4">Download your resources below.</p>

            <div>
                <div class="download-main-sign-image-row">
                    <img id="mainProductImg" src="{{ asset('/imgs/ebook/bump/bump1.png') }}" alt="Cosmic Fortune Calendar Product" class="download-main-img-large" />
                </div> 
                <div class="download-section download-instructions text-center my-5">
                    ...
                    <a class="btn hero-cta mainPdfLink" href="https://cosmic-life-path.nyc3.digitaloceanspaces.com/bump/bmp_cfc_J8qLp4Nx7Rv2Ka9Tm.pdf" download target="_blank">Download Now</a>
                </div>
            </div>
        </div>
