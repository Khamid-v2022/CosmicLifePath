...
<div class="download-page vip">
    ...
    <div class="container">
       ...
       <div class="download-section download-instructions">
        ...
        <section class="pt-4">
            <h1 class="section-title text-center"><em>One Reading Opens the Door. Two Complete the Map.</em></h1>
            ...
            <div class="products-grid">
                <article class="product-card">
                    ...
                    <div class="product-content">
                        ...
                        <a href="https://accelevate8.co/TeslaWealthScript/clpoto1dl" target="_blank" rel="noopener noreferrer" class="btn product-cta">View Program</a>
                    </div>
                </article>
                ...
                <article class="product-card">
                    ...
                    <div class="product-content">
                        ...
                        <a href="https://accelevate8.co/MosesWealthCode/clpoto1dl" target="_blank" rel="noopener noreferrer" class="btn product-cta">View Program</a>
                    </div>
                </article>
                ...
                <article class="product-card">
                    ...
                    <div class="product-content">
                        ...
                        <a href="https://accelevate8.co/WealthWaveScript/clpoto1dl" target="_blank" rel="noopener noreferrer" class="btn product-cta">View Program</a>
                    </div>
                </article>
                ...
                <article class="product-card">
                    ...
                    <div class="product-content">
                        ...
                        <a href="https://accelevate8.co/WealthDreamCode/clpoto1dl" target="_blank" rel="noopener noreferrer" class="btn product-cta">View Program</a>
                    </div>
                </article>
            </div>
        </div>
