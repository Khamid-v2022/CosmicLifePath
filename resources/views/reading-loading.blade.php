      ...
      <div class="">
        ...
        <div class="video-intro-wrap mt-4">
          ...
          <div class="cosmic-video-frame video-thumbnail-frame position-relative mt-3">
            <div id="vidalytics_embed_3iGiV97kgugwhHYn" style="width: 100%; position:relative; padding-top: 56.25%;"></div>
          </div>
...
@push('scripts')
  ...
  <script>
    gtag('event', 'funnel_step_view', {
      ...
      step: 5,
      step_name: @json(funnel_step_name('reading_loading', $ext))
    });
    ...
    function loadVidalyticsVideo() {
     (function (v, i, d, a, l, y, t, c, s) {
        ...
        })(window, document, 'Vidalytics', 'vidalytics_embed_3iGiV97kgugwhHYn', 'https://fast.vidalytics.com/embeds/x4wjDf3w/3iGiV97kgugwhHYn/');
