          ...
          <div class="row g-4 mt-2">
            <div class="col-md-4">
              <div class="proof-card h-100 text-center">
                <img src="{{ asset('imgs/sample-2.png') }}" alt="James Smith" class="testimonial-avatar">
            ...
            <div class="col-md-4">
              <div class="proof-card h-100 text-center">
                <img src="{{ asset('imgs/sample-2.png') }}" alt="Elizabeth Garcia" class="testimonial-avatar">
            ...
            <div class="col-md-4">
              <div class="proof-card h-100 text-center">
                <img src="{{ asset('imgs/sample-2.png') }}" alt="Lauren Martinez" class="testimonial-avatar">
