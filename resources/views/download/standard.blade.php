            ...
            <div class="row">
                <div class="col-md-4 mt-5">
                    <div class="h-100 d-flex flex-column justify-content-between">
                        ...
                        <a class="btn special-instant-download" href="{{ $sign['standard_instant_upsell1_purchase_link'] }}">Get Instant Access</a>
                    </div>
                </div>
                <div class="col-md-4 mt-5">
                    <div class="h-100 d-flex flex-column justify-content-between">
                        ...
                        <a class="btn special-instant-download" href="{{ $sign['standard_instant_upsell2_purchase_link'] }}">Get Instant Access</a>
                    </div>
                </div>
                <div class="col-md-4 mt-5">
                    <div class="h-100 d-flex flex-column justify-content-between">
                        ...
                        <a class="btn special-instant-download" href="{{ $sign['standard_instant_upsell3_purchase_link'] }}">Get Instant Access</a>
                    </div>
                </div>
            </div>
        </section>
