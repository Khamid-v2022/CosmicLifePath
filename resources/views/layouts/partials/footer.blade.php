<footer class="footer-strip container-fluid px-lg-5 text-center">
  ...
  <p class="footer-tems">
    <a href="{{ route('privacy.policy') }}">Privacy Policy</a> | <a href="{{ route('terms.service') }}">Terms of Service</a> | <a href="{{ route('disclaimer') }}">Disclaimer</a> | <a href="{{ route('contact.us') }}">Contact Us</a> | <a href="{{ route('about.us') }}">About Us</a> | <a href="#cookie-settings" data-clp-cookie-settings>Cookie Settings</a>
  </p>
